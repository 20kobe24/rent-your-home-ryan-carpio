    ...
    CredentialsProvider({
      ...
      async authorize(credentials) {
        ...
        if (!user.hashedPassword) {
          console.log('User does not have a hashed password:', user);
          throw new Error('User does not have a hashed password');
        }
        ...
        console.log('Credentials are authorized, returning user:', user);
        return user;
      },
    }),
  ],
